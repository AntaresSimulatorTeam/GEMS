...
The `parameters.yml` file is only required when using the [**Antares Modeler interpreter**](../../1_Overview/4_GEMS%20Interpreters/2_antares_simulator_modeler.md).  
...
<div style="display: flex; justify-content: space-between;">
    ...
    <button type="button" style="background-color:#CCCCCC; border:none; padding:8px 16px; border-radius:4px; cursor:pointer">
        <a href="../5_scenario_builder" style="text-decoration:none; color: #000000">⬅️ Previous page</a>
    </button>
    </div>
    ...
    <div style="text-align: right;">
    <button type="button" style="background-color:#CCCCCC; border:none; padding:8px 16px; border-radius:4px; cursor:pointer">
        <a href="../7_taxonomy" style="text-decoration:none; color: #000000">Next page ➡️</a>
    </button>
    </div>
</div>
