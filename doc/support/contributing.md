...
* For contributing in GEMS **code**, please find the following instructions :
    ...
    ??? note "Code contribution details"

        GEMS repositories containing code:

        - [GemsPy](https://github.com/AntaresSimulatorTeam/GemsPy)
        - [yPSA-to-GEMS-Converter](https://github.com/AntaresSimulatorTeam/PyPSA-to-GEMS-Converter)
        - [AntaresLegacyModel-to-GEMS-COnverter](https://github.com/AntaresSimulatorTeam/AntaresLegacyModels-to-GEMS-Converter)
...
* For contributing in GEMS **documentation**, please use the following instructions :
    ...
    ??? note "Documentation contribution details"
...
* For adding or suggesting changes on ready-to-use **libraries** and **examples**:
    ...
    ??? note "Libraries and Examples contribution details"
