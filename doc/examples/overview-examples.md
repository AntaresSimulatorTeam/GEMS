...
| [PyPSA Eur conversion](quick-start-examples.md#pypsa-eur-example) | Presentation of a workflow to run a PyPSA-Eur study on a remote Linux server using GEMS. |
