...
| Example | Description |
|---------|-------------|
| [Adequacy Quick Start](quick-start-examples.md) | A minimal three-bus adequacy study to get started immediately with GEMS, including input files ready to run. |
