...
| [Antares Legacy to GEMS](notebooks/tutorial-four-antares-legacy/tutorial-antares-legacy.ipynb) | Tutorial showing how to convert an Antares legacy study into a GEMS study using the Antares Legacy converter. |

## Reference Libraries

For helping users to get familiar with GEMS objects, a list of ready-to-use libraries with their source files, and an interactive viewer, inside the [Reference Libraries](../overview/references/libraries.md) page.