---
description: Reference for the GEMS library file — how to define reusable model components with ports, variables, parameters, constraints, and objective contributions in YAML format.
tags:
