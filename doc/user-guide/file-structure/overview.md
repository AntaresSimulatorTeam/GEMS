---
description: Overview of the GEMS study file structure — the four file types (library, system, dataseries, scenario builder) and how they organise an energy system optimisation study.
tags:
