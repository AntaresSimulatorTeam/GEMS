---
description: Step-by-step guide for running a GEMS simulation after PyPSA conversion — how to manually execute an optimisation study in Antares Modeler using the converted files.
tags:
  - Getting Started
  - Interoperability
  - PyPSA
