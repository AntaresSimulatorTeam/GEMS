...
The [PyPSA-to-GEMS](https://github.com/AntaresSimulatorTeam/PyPSA-to-GEMS-Converter) Converter is an open-source & standalone python package that enables the conversion of studies conducted in PyPSA into the GEMS format: it exports a [PyPSA Network](https://docs.pypsa.org/latest/api/networks/network) as a [GEMS](https://gems-energy.readthedocs.io/en/latest/user-guide/input-files/overview/) folder.
