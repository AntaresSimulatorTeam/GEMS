---
description: Input and output specification of the PyPSA-to-GEMS Converter — required PyPSA Network inputs and the GEMS folder structure produced by the conversion process.
tags:
  - Interoperability
  - PyPSA
---
