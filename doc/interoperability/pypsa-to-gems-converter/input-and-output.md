...
Each generated file follows the GEMS file structure conventions: see the [system file](../../user-guide/input-files/system.md), [library file](../../user-guide/input-files/library.md), [data series](../../user-guide/input-files/data-series.md), [solver parameters](../../user-guide/input-files/solver-optimization.md), and [optimization configuration](../../user-guide/input-files/optimization-configuration.md) documentation for details on their format and content.