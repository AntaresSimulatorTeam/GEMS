...
The following table lists reference model libraries developed within projects that make use of the GEMS modelling framework. For the YAML syntax of a [library file](../../user-guide/input-files/library.md), see the User Guide.
