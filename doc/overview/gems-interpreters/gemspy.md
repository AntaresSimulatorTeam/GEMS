---
description: Overview of GemsPy — the standalone Python package for interpreting GEMS models, with API reference for programmatically building and running energy system optimisation studies.
tags:
  - GemsPy
  - Optimisation
  - Open Source
