---
description: Quick-start tutorial for unit commitment modelling with GEMS — determine optimal generator dispatch schedules to meet residual demand at minimum cost using GEMS syntax.
tags:
  - Getting Started
  - Unit Commitment
  - Optimisation
