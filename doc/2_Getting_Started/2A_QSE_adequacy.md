...
The simulation table csv file represents the results of the simulation, and structure of the simulation table is explained on the following [page](../3_User_Guide/4_outputs.md).

The simulation outputs contain the optimized value of optimization problem variables, status of contraints and bounds and user defined extra output. The power flows between buses can be visualized as follows:
