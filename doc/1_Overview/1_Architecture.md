---
description: >-
  Discover the GEMS architecture: how the language separates model definition
  from problem resolution to enable interoperability between solvers and tools.
---
