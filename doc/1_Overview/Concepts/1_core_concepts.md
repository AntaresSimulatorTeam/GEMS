...
They are defined by *variables*, *parameters*, *ports*, and *constraints*. [Examples are provided in the User Guide section.](../../3_User_Guide/1_syntax.md#model-definition-from-systemyml)  
...
- **Parameters [^1]** are data declared in the model, and their values are specific for each component.  
...
- **Parameter value [^1]** is set by users.
...
[^1]: Parameters, Variables, and Constraints can be scenario-dependent or not ; they can be time-dependent or not.
