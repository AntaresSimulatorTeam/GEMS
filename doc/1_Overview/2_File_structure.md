...
The outputs of GEMS consist of three main categories of objects: **Optimization Problem**, **Simulation Table** and **Business Views**. Their structure is detailed in the [User Guide section](../3_User_Guide/5_Outputs/1_simulation_table.md).
